...
<html>
<head>
	<title>ApiDocu - /api/advocate-rankings/</title>
	<style>html, body {
	margin: 0;
	padding: 0;
	height: 100%;
...
<div class="apiDocu-container apiDocu-index">
	...
	<div class="apiDocu-container">
		<div class="apiDocu-url">
			...
			<div class="apiDocu-description apiDocu-description-main">API for obtaining information about advocate rankings</div>
