...
<div class="apiDocu-container apiDocu-index">
	...
	<div class="apiDocu-container">
		<div class="apiDocu-url">
			...
			<div class="apiDocu-description apiDocu-description-main">Get information about case with given ID.<br /><br><pre class="apiDocu-json">    {<br />        <span class="apiDocu-string">"id_case"</span>: 12,<br />        <span class="apiDocu-string">"id_court"</span>: 2,<br />        <span class="apiDocu-string">"registry_mark"</span>: <span class="apiDocu-string">"42 CDO 4000/2016"</span>,<br />        <span class="apiDocu-string">"tagging_advocate"</span>: {<br />            <span class="apiDocu-string">"id_advocate"</span>: 123,<br />            <span class="apiDocu-string">"fullname"</span>: <span class="apiDocu-string">"JUDr. Ing. Petr Omáčka, PhD."</span><br />        },<br />        <span class="apiDocu-string">"tagging_advocate_final"</span>: true,<br />        <span class="apiDocu-string">"tagging_result"</span>: <span class="apiDocu-string">"negative"</span>,<br />        <span class="apiDocu-string">"tagging_result_final"</span>: false,<br />        <span class="apiDocu-string">"tagging_success_result"</span>: <span class="apiDocu-string">"negative"</span>,<br />        <span class="apiDocu-string">"tagging_success_result_final"</span>: false,<br />        <span class="apiDocu-string">"proposition_date"</span>: <span class="apiDocu-string">"2016-03-01T01:00:00+01:00"</span>,<br />        <span class="apiDocu-string">"decision_date"</span>: null,<br />        <span class="apiDocu-string">"documents"</span>: [<br />            {<br />                <span class="apiDocu-string">"id_document"</span>: 543,<br />                <span class="apiDocu-string">"mark"</span>: <span class="apiDocu-string">"ECLI:CZ:NS:2016:42.CDO.4000.2016.1"</span>,<br />                <span class="apiDocu-string">"decision_date"</span>: <span class="apiDocu-string">"2012-04-23T18:25:43.511Z"</span>,<br />                <span class="apiDocu-string">"is_available"</span>: true,<br />                <span class="apiDocu-string">"public_link"</span>: <span class="apiDocu-string">"http:<span class="apiDocu-comment">//example.com/doc/12AS13LAA0"</span></span><br>                <span class="apiDocu-string">"public_local_link"</span>: <span class="apiDocu-string">"http:<span class="apiDocu-comment">//example.com/doc/12AS13LAA0"</span></span><br>            }<br />        ],<br />        <span class="apiDocu-string">"tagging_result_annuled"</span>: true,<br />        <span class="apiDocu-string">"tagging_result_annuled_by_id_cases"</span>: [2, null],<br />        <span class="apiDocu-string">"tagging_result_annuling_id_cases"</span>: [],<br />    }<br /></pre><br />Potential tagging advocate:<br /> - <b>array</b> when tagging present and valid<br /> - <b>null</b> when null, or tagging is invalid<br />Potential tagging result (@see CaseResult):<br /> - <b>negative</b><br /> - <b>neutral</b><br /> - <b>positive</b><br /> - <b>null</b> - when tagging is invalid<br />Potential tagging success result (@see CaseSuccess):<br /> - <b>negative</b><br /> - <b>neutral</b><br /> - <b>positive</b><br /> - <b>unknown</b><br /> - <b>null</b> - when tagging is invalid<br />Potential tagging final result:<br /> - <b>null</b> when tagging doesn't exist<br /> - <b>true</b> when tagging is final<br /> - <b>false</b> when tagging is not final<br />Annuling of cases:<br /> - When this case is annuled then <b>tagging_result_annuled</b> is true, otherwise false.<br /> - When this case is annuled then <b>tagging_result_annuled_by_id_cases</b> contains array with ids of cases which annuled this case (or nulls when we don't have this information)<br /> - When this case is annuling any case then <b>tagging_result_annuling_id_cases</b> contains ids of annuled cases<br />Note: provides only cases which are relevant for advocates portal.<br />Note: columns <b>public_link</b> and <b>public_local_link</b> are only available when <b>is_available</b> is true<br />Errors:<br /> - Returns HTTP 404 with error <b>no_case</b> when such case doesn't exist</div>
