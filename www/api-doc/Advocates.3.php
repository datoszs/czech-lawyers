...
<div class="apiDocu-container apiDocu-index">
	...
	<div class="apiDocu-container">
		<div class="apiDocu-url">
			...
			<div class="apiDocu-description apiDocu-description-main">Get advocate cases fulfilling given filters (or all when no filters given)<br /><br><pre class="apiDocu-json">    {<br />        <span class="apiDocu-string">"id_advocate"</span>: 123,<br />        <span class="apiDocu-string">"id_court"</span>: 2,<br />        <span class="apiDocu-string">"year"</span>: 2016<br />        <span class="apiDocu-string">"result"</span>: <span class="apiDocu-string">"negative"</span><br />        <span class="apiDocu-string">"cases"</span> : [<br />            {<br />                <span class="apiDocu-string">"id_case"</span>: 25,<br />                <span class="apiDocu-string">"id_court"</span>: 2,<br />                <span class="apiDocu-string">"registry_mark"</span>: <span class="apiDocu-string">"42 CDO 4000/2016"</span>,<br />                <span class="apiDocu-string">"tagging_result"</span>: <span class="apiDocu-string">"negative"</span>,<br />                <span class="apiDocu-string">"tagging_success_result"</span>: <span class="apiDocu-string">"negative"</span>,<br />                <span class="apiDocu-string">"proposition_date"</span>: <span class="apiDocu-string">"2016-03-01T01:00:00+01:00"</span>,<br />                <span class="apiDocu-string">"decision_date"</span>: null,<br />                <span class="apiDocu-string">"tagging_result_annuled"</span>: true,<br />                <span class="apiDocu-string">"tagging_result_annuled_by_id_cases"</span>: [2, null],<br />            }<br />        ]<br />    }<br /></pre><br />Through query object additional filters can be provided:<br /> - <b>id_court</b> (e.g. 2)<br /> - <b>year</b> (e.g. 2016)<br /> - <b>result</b> (e.g. negative)<br />Available results (@see CaseResult):<br /> - <b>negative</b><br /> - <b>neutral</b><br /> - <b>positive</b><br /> - <b><i>null</i></b> when no result available<br />Available results (@see CaseResult):<br /> - <b>negative</b><br /> - <b>neutral</b><br /> - <b>positive</b><br /> - <b>unknown</b><br /> - <b><i>null</i></b> when no result available<br />Annuling of cases:<br /> - When this case is annuled then <b>annuled</b> is true, otherwise false.<br /> - When this case is annuled then <b>annuled_by_id_cases</b> contains array with ids of cases which annuled this case (or nulls when we don't have this information)<br />When additional filter is provided its value is returned in response (in the root).<br />Note: provides only cases which are relevant for advocates portal.<br />Errors:<br /> - Returns HTTP 404 with error <b>no_advocate</b> when such advocate doesn't exist<br /> - Returns HTTP 400 with error <b>invalid_court</b> when given court is invalid<br /> - Returns HTTP 400 with error <b>invalid_result</b> when given case result type is invalid</div>
