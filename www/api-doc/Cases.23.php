...
<div class="apiDocu-container apiDocu-index">
	...
	<div class="apiDocu-container">
		<div class="apiDocu-url">
			...
			<div class="apiDocu-description apiDocu-description-main">Get relevant case<br />Returns list of matched cases.<br /><br><pre class="apiDocu-json">    [<br />        {<br />            <span class="apiDocu-string">"id_case"</span>: 234000,<br />            <span class="apiDocu-string">"id_court"</span>: 3,<br />            <span class="apiDocu-string">"registry_mark"</span>: <span class="apiDocu-string">"22 Cdo 2045/2012"</span>,<br />            <span class="apiDocu-string">"tagging_result"</span>: <span class="apiDocu-string">"positive"</span>,<br />            <span class="apiDocu-string">"tagging_result_final"</span>: true,<br />            <span class="apiDocu-string">"tagging_success_result"</span>: <span class="apiDocu-string">"positive"</span>,<br />            <span class="apiDocu-string">"tagging_success_result_final"</span>: true,<br />            <span class="apiDocu-string">"tagging_result_annuled"</span>: true,<br />            <span class="apiDocu-string">"tagging_result_annuled_by_id_cases"</span>: [2, null],<br />        },<br />    ]<br /></pre><br />There is one optional GET parameter:<br /> - strategy - determines the matching strategy (from <b>start</b>, to <b>end</b> or anywhere in the <b>middle</b>).<br />Annuling of cases:<br /> - When this case is annuled then <b>tagging_result_annuled</b> is true, otherwise false.<br /> - When this case is annuled then <b>tagging_result_annuled_by_id_cases</b> contains array with ids of cases which annuled this case (or nulls when we don't have this information)<br />Note: provides only cases which are relevant for advocates portal.</div>
