...
<div class="apiDocu-container apiDocu-index">
	...
	<div class="apiDocu-container">
		<div class="apiDocu-url">
			...
			<div class="apiDocu-description apiDocu-description-main">Get advocates of given decile in advocate rankings for all courts (or given one when present).<br /><br><pre class="apiDocu-json">    {<br />        <span class="apiDocu-string">"1"</span>: [<br />                 {<br />                      <span class="apiDocu-string">"id_advocate"</span>: 123,<br />                      <span class="apiDocu-string">"fullname"</span>: <span class="apiDocu-string">"JUDr. Ing. Petr Omáčka, PhD."</span>,<br />                      <span class="apiDocu-string">"sorting_name"</span>: <span class="apiDocu-string">"Omáčka, Petr"</span>,<br />                 }<br />        ],<br />        <span class="apiDocu-string">"2"</span>: [<br />                 {<br />                     <span class="apiDocu-string">"id_advocate"</span>: 1118,<br />                     <span class="apiDocu-string">"fullname"</span>: <span class="apiDocu-string">"JUDr. Stanislav Morče"</span>,<br />                     <span class="apiDocu-string">"sorting_name"</span>: <span class="apiDocu-string">"Morče, Stanislav"</span>,<br />                 }<br />        ]<br />    }<br /></pre><br />There are two optional GET parameters:<br /> - <b>id_court</b> (e.g. 2) - when present, only advocates from this court are returned<br /> - <b>reverse</n> - presence indicates reverse sorting (usable for last people from given decile)<br />Errors:<br /> - Returns HTTP 400 with error <b>invalid_decile</b> when decile is invalid or out of range<br /> - Returns HTTP 400 with error <b>invalid_court</b> when given court is invalid</div>
