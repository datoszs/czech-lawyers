...
<div class="apiDocu-container apiDocu-index">
	...
	<div class="apiDocu-container">
		<div class="apiDocu-url">
			...
			<div class="apiDocu-description apiDocu-description-main">Get information about advocate with given ID.<br /><br><pre class="apiDocu-json">    {<br />        <span class="apiDocu-string">"id_advocate"</span>: 123,<br />        <span class="apiDocu-string">"remote_identificator"</span>: <span class="apiDocu-string">"77b3dbfb-f855-4170-9d5b-dc30757a0204"</span>,<br />        <span class="apiDocu-string">"identification_number"</span>: <span class="apiDocu-string">"11223344"</span>,<br />        <span class="apiDocu-string">"registration_number"</span>: <span class="apiDocu-string">"00001"</span>,<br />        <span class="apiDocu-string">"fullname"</span>: <span class="apiDocu-string">"JUDr. Ing. Petr Omáčka, PhD."</span>,<br />        <span class="apiDocu-string">"residence"</span>: {<br />            <span class="apiDocu-string">"street"</span>: <span class="apiDocu-string">"Pod mostem"</span>,<br />            <span class="apiDocu-string">"city"</span>: <span class="apiDocu-string">"Brno"</span>,<br />            <span class="apiDocu-string">"postal_area"</span>: <span class="apiDocu-string">"602 00"</span><br />        },<br />        <span class="apiDocu-string">"emails"</span>: [<br />            <span class="apiDocu-string">"petr.omacka@example.com"</span><br />        ],<br />        <span class="apiDocu-string">"state"</span>: <span class="apiDocu-string">"active"</span>,<br />        <span class="apiDocu-string">"location: {<br />            "</span>lat": 49.1234,<br />            <span class="apiDocu-string">"long"</span>: 16.1234<br />        },<br />        <span class="apiDocu-string">"remote_page"</span>: <span class="apiDocu-string">"http:<span class="apiDocu-comment">//vyhledavac.cak.cz/Contact/Details/77b3dbfb-f855-4170-9d5b-dc30757a0204"</span>,</span><br>        <span class="apiDocu-string">"statistics"</span>: {<br />            <span class="apiDocu-string">"negative"</span>: 12,<br />            <span class="apiDocu-string">"neutral"</span>: 2,<br />            <span class="apiDocu-string">"positive"</span>: 59<br />        },<br />        <span class="apiDocu-string">"success_statistics"</span>: {<br />            <span class="apiDocu-string">"negative"</span>: 64,<br />            <span class="apiDocu-string">"neutral"</span>: 2,<br />            <span class="apiDocu-string">"positive"</span>: 5,<br />            <span class="apiDocu-string">"unknown"</span>: 2<br />        },<br />        <span class="apiDocu-string">"court_statistics"</span>: {<br />            <span class="apiDocu-string">"1"</span>: {<br />                <span class="apiDocu-string">"negative"</span>: 11,<br />                <span class="apiDocu-string">"neutral"</span>: 1,<br />                <span class="apiDocu-string">"positive"</span>: 57<br />            },<br />            <span class="apiDocu-string">"2"</span>: {<br />                <span class="apiDocu-string">"negative"</span>: 1,<br />                <span class="apiDocu-string">"neutral"</span>: 1,<br />                <span class="apiDocu-string">"positive"</span>: 2<br />            }<br />        }<br />        <span class="apiDocu-string">"court_success_statistics"</span>: {<br />            <span class="apiDocu-string">"1"</span>: {<br />                <span class="apiDocu-string">"negative"</span>: 63,<br />                <span class="apiDocu-string">"neutral"</span>: 1,<br />                <span class="apiDocu-string">"positive"</span>: 3<br />            },<br />            <span class="apiDocu-string">"2"</span>: {<br />                <span class="apiDocu-string">"negative"</span>: 1,<br />                <span class="apiDocu-string">"neutral"</span>: 1,<br />                <span class="apiDocu-string">"positive"</span>: 2,<br />                <span class="apiDocu-string">"unknown"</span>: 2<br />            }<br />        }<br />        <span class="apiDocu-string">"advocates_with_same_name"</span>: [<br />            {<br />                <span class="apiDocu-string">"id_advocate"</span>: 125,<br />                <span class="apiDocu-string">"fullname"</span>: <span class="apiDocu-string">"Mgr. Petr Omáčka"</span>,<br />                <span class="apiDocu-string">"residence"</span>: {<br />                    <span class="apiDocu-string">"street"</span>: <span class="apiDocu-string">"Františkánská 65"</span>,<br />                    <span class="apiDocu-string">"city"</span>: <span class="apiDocu-string">"Brno"</span>,<br />                    <span class="apiDocu-string">"postal_area"</span>: <span class="apiDocu-string">"602 00"</span><br />                },<br />            },<br />            {<br />                <span class="apiDocu-string">"id_advocate"</span>: 125,<br />                <span class="apiDocu-string">"fullname"</span>: <span class="apiDocu-string">"JUDr. Petr Ostrý"</span>,<br />                <span class="apiDocu-string">"residence"</span>: {<br />                    <span class="apiDocu-string">"street"</span>: <span class="apiDocu-string">"Opálkova 2a"</span>,<br />                    <span class="apiDocu-string">"city"</span>: <span class="apiDocu-string">"Brno"</span>,<br />                    <span class="apiDocu-string">"postal_area"</span>: <span class="apiDocu-string">"635 00"</span><br />                },<br />            },<br />        ]<br />        <span class="apiDocu-string">"rankings"</span>: {<br />            <span class="apiDocu-string">"decile"</span>: 2<br />        }<br />    }<br /></pre><br />Available advocate states (see @see AdvocateStatus):<br /> - <b>active</b><br /> - <b>suspended</b><br /> - <b>removed</b><br />Available statistics results (@see CaseResult):<br /> - <b>negative</b><br /> - <b>neutral</b><br /> - <b>positive</b><br />Available statistics success results (@see CaseSuccess):<br /> - <b>negative</b><br /> - <b>neutral</b><br /> - <b>positive</b><br /> - <b>unknown</b><br />Note: when advocate is in state <b>removed</b>, then emails field is null.<br />Note: when advocate (queried or with same name) is in state <b>removed<b>, then fields street and postal_area as well as location are null.<br />Note: both statistics take into account only cases which are relevant for advocates portal.<br />Note: advocates with same name also match historic names on both sides, but shows only up-to-date names.<br />In example Petr Ostrý was previously named Petr Omáčka or the queried advocate was names Petr Ostrý.<br />Match is performed on names only (without degrees).<br />Errors:<br /> - Returns HTTP 404 with error <b>no_advocate</b> when such advocate doesn't exist</div>
